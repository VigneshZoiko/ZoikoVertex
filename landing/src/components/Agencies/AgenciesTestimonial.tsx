...
const STATS = [
  { label: "Client-isolated", sub: "Brand Workspaces" },
  { label: "Complete", sub: "Approval Evidence" },
  { label: "Scalable", sub: "Across All Accounts" },
];

export default function AgenciesTestimonial() {
  return (
    <section className="relative bg-[#0C1523] border-t border-white/[0.06] overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/agencies/testimonial-bg.png"
          alt=""
          fill
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-24 grid lg:grid-cols-2 gap-16 items-center">
        <div>
          <div
            className="mb-6 font-black select-none"
            style={{
              width: 28.22,
              height: 64,
              fontSize: 80,
          ...
          <blockquote className="text-white text-[clamp(1.4rem,2.2vw,1.75rem)] font-bold leading-snug mb-8">
            Clients used to ask us to prove what was approved and when. We had email chains to dig through. With ZoikoVertex, the answer is always ready — a complete, timestamped record of every approval decision.
          </blockquote>
          <div
          ...
          >
            <div className="text-white font-bold text-[15px]">[Agency Operations Director]</div>
            <div className="text-[#20E7F2] text-[11px] font-mono uppercase tracking-[0.1em]">
              Marketing Agency — Profile Pending Approval
            </div>
          </div>
        </div>
        ...
        <div className="relative rounded-2xl overflow-hidden border border-white/10">
          <div className="relative h-[280px]">
            <Image
              src="/images/agencies/testimonial-lead.png"
              alt="Agency Operations Director"
              fill
