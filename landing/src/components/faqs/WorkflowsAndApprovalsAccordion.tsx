...
const accordionData: AccordionItem[] = [
  {
    id: "01",
    question: "Can humans approve or reject AI outputs before publishing?",
    answerBold: "Yes. ZoikoVertex supports structured approval workflows.",
    answerRest:
      " Human reviewers and approvers can edit, approve, reject, escalate, or request changes before work moves forward.",
  },
  {
    id: "02",
    question: "Can we require legal review on specific workflows?",
    answerBold:
      "Yes, multi-stage approval gates can be configured for sensitive content.",
    answerRest:
      " Workflows can automatically mandate legal, compliance, or executive review based on predefined rules, keywords, or risk assessments.",
  },
  {
    id: "03",
    question: "Can approval rules vary by team, market, or risk level?",
    answerBold:
      "Absolutely. Governance policies are granular and highly adaptable.",
    answerRest:
      " You can define distinct routing logic, threshold conditions, and required sign-offs tailored to specific departments, geographic regions, or project risk profiles.",
  },
];
...
export default function WorkflowsAndApprovalsAccordion() {
