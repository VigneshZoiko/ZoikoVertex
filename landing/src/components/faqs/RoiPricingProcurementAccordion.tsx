...
const accordionData: AccordionItem[] = [
  {
    ...
    answerBold:
      "ROI is measured through workflow time saved, approval cycle reduction, reduced rework,",
    answerRest:
      " improved campaign throughput, governance risk reduction, and agent utilization.",
  },
  {
    id: "02",
    question: "How do we build a business case?",
    answerBold:
      "We provide tailored financial models and efficiency impact templates.",
    answerRest:
      " These tools help quantify saved resource hours, risk mitigation value, and output acceleration across key departments.",
  },
  {
    id: "03",
    question: "What does implementation require?",
    answerBold:
      "Rapid deployment with minimal disruption to existing technology stacks.",
    answerRest:
      " Our team assists with SSO integration, RBAC configuration, approval flow mapping, and initial agent policy setup within days.",
  },
  {
    id: "04",
    question: "How do we speak with sales?",
    answerBold:
      "Schedule a technical demo or procurement consultation directly.",
    answerRest:
      " Reach out via our contact portal or connect with your dedicated account manager to discuss enterprise licensing and custom trial environments.",
  },
];
...
export default function RoiPricingProcurementAccordion() {
