...
const marketPills: MarketPill[] = [
  ...
  },
  {
    ...
    marketSize: "$13.2B market",
  },
  {
    label: "BI & analytics",
    marketSize: "$29.4B market",
  },
  {
    label: "AI copilots",
    ...
    <section className="relative w-full min-h-[85vh] bg-[#0B0F17] font-sans text-white flex flex-col justify-center overflow-hidden py-20 px-4 sm:px-8 md:px-12 lg:px-24">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-5xl lg:text-[54px] font-bold tracking-tight text-white leading-[1.12] mb-6 max-w-4xl"
        >
        ...
        >
          <p className="font-mono text-xs sm:text-[13px] text-[#20E7F2] leading-relaxed">
            &quot;The comparison is not between one dashboard and another. It
            is between fragmented AI activity and governed agentic
            execution.&quot;
          </p>
        </motion.div>
        ...
        >
          ...
          <Link
            href="/platform"
            className="inline-flex items-center gap-2 bg-[#20E7F2] hover:bg-[#00BFA3] text-[#090D16] font-mono text-xs sm:text-sm font-semibold tracking-wide px-5 py-3 rounded-full transition-colors duration-200"
          >
          ...
          <a
            href="#benchmark"
            className="inline-flex items-center gap-2 hover:bg-[#1E293B] text-white border border-slate-700 font-mono text-xs sm:text-sm font-medium tracking-wide px-5 py-3 rounded-full transition-colors duration-200 backdrop-blur-sm"
          >
        ...
        >
          ...
          {jumpLinks.map((link) => {
            ...
            return (
              <div
                key={link.label}
                className="inline-flex items-center gap-1.5 bg-[#FFFFFF0E] border border-[#FFFFFF1A] rounded-full px-3 py-1.5 font-mono text-[11px] text-[#FFFFFF85] backdrop-blur-sm"
              >
