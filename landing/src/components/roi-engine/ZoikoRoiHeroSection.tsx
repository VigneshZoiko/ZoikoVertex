        ...
        >
          ...
          <div className="w-full lg:w-[55%] space-y-6">
            ...
            >
              ...
              <span className="text-[#20E7F2] text-[60px]">
                AI workflow.
              </span>
            </motion.h1>
            ...
            >
              ...
              efficiency, content throughput, governance evidence, and
              executive oversight — with conservative scenarios built for
              serious enterprise buyers.
            </motion.p>
            ...
            >
              {/* Calculate ROI - SAME PAGE */}
              <Link
                href="#calculate"
                className="inline-flex items-center gap-3 px-10 py-3 rounded-full bg-[#20E7F2] text-[#0d0f12] font-semibold text-sm hover:bg-[#1cd4de] transition-colors shadow-lg shadow-[#20E7F2]/20"
              >
              ...
              <Link
                href="/request-demo"
                className="inline-flex items-center gap-3 px-10 py-3 rounded-full border border-[#FFFFFF1A] text-white font-semibold text-sm hover:bg-white/10 transition-colors backdrop-blur-sm"
              >
