...
const SOLUTION_ITEMS = [
  ...
  {
    label: "B2B SaaS",
    desc: "Governed marketing\nfor SaaS teams",
    href: "/b2b-saas",
  },
  {
    label: "FinTech",
    desc: "Compliant marketing\nfor financial services",
    href: "/fintech",
  },
  {
    label: "Healthcare",
    ...
    >
      ...
      <div
        style={{
          ...
          display: "grid",
          gridTemplateColumns: `repeat(${items.length > 5 ? 4 : 3}, 1fr)`,
          rowGap: 28,
          columnGap: 16,
        }}
      >
        {items.map((item) => (
          ...
          >
            <div
              style={{ display: "flex", flexDirection: "column", gap: 10.8 }}
            >
              <IconBox>
                <PlaceholderIcon />
              </IconBox>
...
export default function Navbar() {
  ...
  const closeDropdowns = () => setOpenMenu(null);
              ...
              >
                {item.hasDropdown ? (
                  ...
                  <Link
                    href={item.href}
                    onClick={closeDropdowns}
                    style={{ ...linkStyle, padding: "0 14px" }}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.color = "#FFFFFF")
                    }
                    onMouseLeave={(e) =>
                ...
                {openMenu === item.label && item.label === "Platform" && (
                  <DropdownMenu
                    ...
                    title="Platform"
                    viewAllLabel="Platform Overview →"
                ...
                {openMenu === item.label && item.label === "About Us" && (
                  <DropdownMenu
                    items={ABOUT_ITEMS}
                    title="About Us"
                    viewAllLabel="About ZoikoVertex →"
                    viewAllHref="/about"
                    onClose={closeDropdowns}
                  />
                )}
