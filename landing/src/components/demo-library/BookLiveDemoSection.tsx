...
export default function BookLiveDemoSection() {
  ...
  return (
    <section id="book-live-demo" className="relative min-h-screen w-full bg-[#030711] text-white px-6 py-16 md:px-12 lg:px-20 flex items-center justify-center font-sans overflow-hidden">
