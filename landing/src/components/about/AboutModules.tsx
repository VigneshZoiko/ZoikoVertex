      ...
      <div ref={ref} className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <p className="text-white/40 text-sm leading-relaxed">
            ZoikoVertex is structured as eight governed layers — each with a
            defined structural role in the execution chain. Together they form
            the world&apos;s first Governed Execution Infrastructure platform.
          </p>
        </div>
          ...
          {MODULES.map((mod, i) => {
            ...
            return (
              <a
                ...
                className={`relative flex flex-col justify-between rounded-2xl p-5 cursor-pointer transition-all duration-300 ease-out ${
                  visible
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-8"
                }`}
