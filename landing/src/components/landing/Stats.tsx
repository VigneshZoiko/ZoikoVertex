  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 divide-y sm:divide-y-0 divide-x-0 sm:divide-x" style={{ borderColor: "#E3E9F0", border: "1px solid #E3E9F0", borderRadius: 12, overflow: "hidden" }}>
          {stats.map((s) => (
            <div key={s.label} className="bg-white px-6 sm:px-8 py-8 sm:py-10">
              <p
