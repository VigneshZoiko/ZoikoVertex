...
const STATS = [
  { label: "Ops-verified", sub: "Service Claims" },
  { label: "Multi-region", sub: "Governance Model" },
  { label: "Complete", sub: "Client Evidence" },
];

export default function LogisticsTestimonial() {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-24 grid lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <blockquote className="text-white text-[clamp(1.4rem,2.2vw,1.75rem)] font-bold leading-snug mb-8">
            Logistics marketing needs to match operational reality. If we say we deliver in two days to a region, that claim needs operations sign-off before it goes anywhere near a customer. ZoikoVertex makes that workflow automatic.
          </blockquote>
          <div
          ...
          >
            <div className="text-white font-bold text-[15px]">[Head of Commercial Marketing]</div>
            <div className="text-[#20E7F2] text-[11px] font-mono uppercase tracking-[0.1em]">
              Logistics Organization — Profile Pending Approval
            </div>
          </div>
        </div>
        ...
        <div className="relative rounded-2xl overflow-hidden border border-white/10">
          <div className="relative h-[280px]">
            <Image
              src="/images/logistics/testimonial-headshot.jpg"
              alt="Head of Commercial Marketing"
              fill
