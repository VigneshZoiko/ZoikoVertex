    ...
    <section className="bg-[#080d1a] border-t border-white/[0.06] py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
        ...
        <p className="text-white/50 text-[15px] leading-relaxed max-w-2xl mx-auto mb-14">
          Every healthcare marketing workflow in ZoikoVertex follows this governed execution model — with approval controls, evidence records, and human oversight built into each stage.
        </p>
