...
export default function AgencyWorkflowsCTASection() {
  ...
  return (
    <section className="relative w-full min-h-[520px] sm:min-h-[600px] flex items-center justify-center bg-[#080C10] text-white overflow-hidden py-20 px-6 sm:px-10 lg:px-16">
      {/* Background Image with Dark Overlay Vignette */}
      <Image
        src="/images/agency-workflows/cta.png"
        alt="Agency office background"
        fill
      ...
      >
        ...
        >
          ...
          <span className="text-[10px] sm:text-[11px] tracking-[0.2em] uppercase font-mono text-[#20E7F2]">
            AGENCY WORKFLOWS • ZOIKOVERTEX
          </span>
        </motion.div>
        ...
        >
          ...
          <span className="text-[#20E7F2] block sm:inline">
        ...
        >
          ZoikoVertex gives agencies the governed AI execution platform that
          turns client work into a repeatable, evidenced, and defensible
          delivery model — across every client in the portfolio.
        </motion.p>
        ...
        >
          ...
          <a
            href="/request-demo"
            className="inline-flex items-center gap-2 bg-[#20E7F2] text-[#080C10] text-xs font-bold px-6 py-3 rounded-full hover:bg-[#20E7F2]/90 transition-all duration-200 shadow-lg shadow-[#20E7F2]/20"
          >
          ...
          <a
            href="/partnerships"
            className="inline-flex items-center gap-2 hover:bg-[#FFFFFF1A] border border-white/10 px-5 py-3 rounded-full text-xs text-white font-medium backdrop-blur-sm transition-colors duration-200"
          >
