...
export default function B2BSaaSProcess() {
  return (
    <section className="bg-[#080d1a] border-t border-white/[0.06] py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
        <div className="inline-flex items-center gap-2 mb-4">
          <span className="w-4 h-px bg-[#8B5CF6]" />
          <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#8B5CF6]">Governed Execution Model</span>
        </div>
        ...
        <p className="text-white/50 text-[15px] leading-relaxed max-w-2xl mx-auto mb-14">
          Every b2b saas marketing workflow in ZoikoVertex follows this governed execution model — with approval controls, evidence records, and human oversight built into each stage.
        </p>
