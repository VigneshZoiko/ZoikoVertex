      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <Link href="https://getzoikovertex.com/signup" className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-6 py-3 rounded-xl text-sm transition-colors">
              {tabs[0].cta}
            </Link>
          </div>
          <div className="space-y-5">
    ...
    <section className="py-28 px-6 text-center" style={{ background: "linear-gradient(160deg,#0d1a35 0%,#080d1a 100%)" }}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-6">
          <Link href="https://getzoikovertex.com/signup" className="bg-cyan-400 hover:bg-cyan-300 text-black font-bold px-8 py-3.5 rounded-xl transition-all text-sm flex items-center gap-2">
