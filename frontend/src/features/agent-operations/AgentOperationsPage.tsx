      ...
      <section className="rounded-3xl border border-[var(--border)] bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.18),transparent_32%),var(--card)] p-5 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button onClick={() => openAction(selectedRun, "create_incident")} className="inline-flex items-center gap-2 rounded-xl bg-rose-500 px-3 py-2 text-sm font-semibold text-gray-900 dark:text-white"><Siren className="h-4 w-4" /> Incident</button>
          </div>
        </div>
