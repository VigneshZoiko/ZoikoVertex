...
export const ROLE_GROUP_MAPPING: Record<string, string[]> = {
  "platform": ["SUPERADMIN"],
  "command": ["ADMIN", "WORKSPACE_OWNER"],
  "media": ["ADMIN", "WORKSPACE_OWNER"],
  "validation": ["ADMIN", "WORKSPACE_OWNER", "GOVERNANCE_ADMIN"],
  "agents": ["ADMIN", "WORKSPACE_OWNER"],
  "governance": ["ADMIN", "WORKSPACE_OWNER", "GOVERNANCE_ADMIN"],
  "integrations": ["ADMIN", "WORKSPACE_OWNER"],
  "access": ["ADMIN", "WORKSPACE_OWNER"],
  "admin": ["ADMIN", "WORKSPACE_OWNER", "SUPERADMIN"]
};
