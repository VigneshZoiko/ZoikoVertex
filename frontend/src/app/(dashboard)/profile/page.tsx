        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl shadow-sm overflow-hidden animate-content-fade">
          <div className="px-8 py-6 border-b border-[var(--border)] flex items-center justify-between">
            ...
            <button
              onClick={saveProfile}
              disabled={saving}
              className="px-6 py-2 bg-[#1a365d] hover:bg-[#1e3a8a] disabled:opacity-60 text-white text-sm font-bold rounded-lg transition-all active:scale-95 shadow-md"
            >
              ...
              <div className="space-y-6 max-w-4xl">
                ...
                <div className="flex items-center justify-between pt-4">
                  ...
                  <button
                    ...
                    disabled={pwSaving}
                    className="px-6 py-2.5 bg-[#8b949e] hover:bg-indigo-500 text-white text-sm font-bold rounded-lg transition-all active:scale-95 shadow-sm"
                  >
