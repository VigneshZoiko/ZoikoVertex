    ...
    return (
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="bg-[#111] border border-[#222] rounded-xl p-12 text-center">
          ...
          <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Failed to Load Event</h2>
    ...
    return (
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="bg-[#111] border border-[#222] rounded-xl p-12 text-center">
          ...
          <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Event Not Found</h2>
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="bg-[#111] border border-[#222] rounded-xl p-6 mb-4">
        <div className="flex items-start justify-between mb-3">
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">{event.event_title || event.event_type}</h1>
...
function TimelineTab({ event, related }: { event: AuditEvent; related: AuditEvent[] }) {
  ...
  return (
    <div className="bg-[#111] border border-[#222] rounded-xl p-5">
      <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-4">Event Timeline ({allEvents.length} events)</h3>
      {allEvents.length === 0 ? (
            ...
            return (
              <div key={evt.id} className="flex gap-3">
                ...
                <div className={`pb-4 flex-1 ${isTarget ? "bg-amber-500/5 -mx-3 px-3 rounded" : ""}`}>
                  ...
                  <div className="text-sm text-gray-900 dark:text-white font-medium">{evt.event_title || evt.event_type}</div>
...
function DiffTab({ event }: { event: AuditEvent }) {
  ...
  return (
    <div className="bg-[#111] border border-[#222] rounded-xl p-5">
      <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-4">Field Changes</h3>
      <div className="space-y-3">
        {change.field_changed ? (
          <div className="border border-[#222] rounded-lg p-3">
            ...
            <div className="text-sm text-gray-900 dark:text-white font-mono">{String(change.field_changed)}</div>
          </div>
        ) : null}
...
function AuthorityTab({ event }: { event: AuditEvent }) {
  ...
  return (
    <div className="bg-[#111] border border-[#222] rounded-xl p-5">
      <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-4">Permission & Policy Context</h3>
...
function IntegrityTab({ event }: { event: AuditEvent }) {
  ...
  return (
    <div className="bg-[#111] border border-[#222] rounded-xl p-5">
      <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-4">Cryptographic Proof</h3>
        ...
        <div className="space-y-3">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-900 dark:text-white">Event Created</div>
          ...
          {isPreserved && (
            <div className="flex gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-900 dark:text-white">Preserved to Vault</div>
