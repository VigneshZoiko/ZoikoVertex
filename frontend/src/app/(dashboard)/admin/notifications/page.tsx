        ...
        <div className="px-6 py-4 border-b border-[var(--border)] flex items-center gap-4 bg-[var(--surface-hover)]/30">
          ...
          >
            ...
            {state.notifications.filter(n => !n.read).length > 0 && (
              <span className={`ml-2 px-1.5 py-0.5 rounded-full text-[10px] ${filter === 'UNREAD' ? 'bg-[var(--background)] text-[var(--foreground)]' : 'bg-indigo-500 text-gray-900 dark:text-white'}`}>
