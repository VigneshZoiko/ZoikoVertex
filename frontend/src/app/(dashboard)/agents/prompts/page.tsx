        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-black border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-xs text-gray-900 dark:text-white focus:outline-none focus:border-indigo-500 transition-all"
            />
          </div>
            ...
            {filtered.map((p) => (
              <tr key={p.id} className="hover:bg-slate-900/30 transition-colors group cursor-pointer" onClick={() => onSelectPrompt(p)}>
                <td className="py-4 px-5">
                  <div className="text-sm font-bold text-gray-900 dark:text-white group-hover:text-indigo-400 transition-colors max-w-[200px] truncate">{p.name}</div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-950 border border-slate-900 rounded-2xl p-6 space-y-4">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Control Rules</h3>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: "Tested Prompts", value: withTests.length, color: "text-gray-900 dark:text-white" },
      ...
      {/* Test Categories */}
      <div className="space-y-3">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Required Test Suites by Category</h3>
          ...
          {TEST_CATEGORIES.map((cat) => {
            ...
            return (
              <div key={cat.label} className="flex items-start gap-4 p-4 bg-black border border-slate-900 rounded-2xl hover:border-indigo-500/30 transition-all">
                ...
                <div>
                  <div className="text-[11px] font-bold text-gray-900 dark:text-white">{cat.label}</div>
      ...
      <div className="space-y-3">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Last Test Run — Per Prompt</h3>
        <div className="space-y-2">
          {prompts.map((p) => (
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Adversarial Validation — Attack Vector Coverage</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            <div key={v.label} className="flex gap-3 p-4 bg-black border border-slate-900 rounded-2xl hover:border-rose-500/20 transition-all">
              ...
              <div>
                <div className="text-[11px] font-bold text-gray-900 dark:text-white mb-1">{v.label}</div>
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Pending Approval Queue</h3>
      ...
      {/* Approval Matrix */}
      <div className="space-y-3">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Risk-Based Approval Matrix</h3>
        <div className="space-y-2">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: "Total Events", value: auditStats?.total ?? 0, color: "text-gray-900 dark:text-white" },
      ...
      {/* Evidence types */}
      <div className="space-y-3">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Evidence Object Types</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {EVIDENCE_TYPES.map((e) => {
            ...
            return (
              <div key={e.label} className="flex items-start gap-3 p-4 bg-black border border-slate-900 rounded-2xl">
                ...
                <div>
                  <div className="text-[11px] font-bold text-gray-900 dark:text-white">{e.label}</div>
      ...
      <div className="space-y-3">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Export Evidence Packages — Production Active</h3>
      ...
      {/* Governance Receipts */}
      <div className="space-y-3">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Governance Receipts — Production Deployments</h3>
              ...
              <div key={p.id} className="bg-black border border-indigo-500/15 rounded-2xl overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3 border-b border-slate-900 bg-indigo-500/5">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[11px] font-black text-gray-900 dark:text-white">{p.name}</span>
...
function RuntimeTab({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* HITL Rules */}
      <div className="space-y-3">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Active HITL Rules — Runtime Routing</h3>
        {hitlRules.length === 0 ? (
          ...
          <div className="space-y-2">
            {hitlRules.map((rule) => (
              <div key={rule.id} className="flex items-center gap-4 p-4 bg-black border border-slate-900 rounded-2xl">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-[11px] font-bold text-gray-900 dark:text-white">{rule.trigger}</div>
      ...
      <div className="space-y-3">
        <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest">Runtime Enforcement Rules</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-1">
        <h2 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest">Prompt Governance Auditor</h2>
      ...
      <div className="bg-black border border-slate-800 rounded-2xl p-6 space-y-4">
        <div className="flex items-center gap-3">
          <div className="space-y-1 flex-1">
            ...
            <select value={tier} onChange={e => setTier(e.target.value as AuditRiskTier)}
              className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2.5 text-xs text-gray-900 dark:text-white focus:outline-none focus:border-indigo-500 transition-all">
        ...
        <div className="space-y-1">
          ...
          <textarea value={prompt} onChange={e => setPrompt(e.target.value)} rows={9}
            ...
            className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-xs text-gray-900 dark:text-white placeholder:text-slate-700 focus:outline-none focus:border-indigo-500 resize-none font-mono transition-all leading-relaxed" />
        ...
        <div className="flex gap-3">
          <button onClick={handleAudit} disabled={!prompt.trim() || running}
            className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-gray-900 dark:text-white text-[10px] font-black uppercase tracking-widest transition-all disabled:opacity-50 disabled:cursor-not-allowed">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-black border border-slate-800 rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-5">
              <div className="w-1 h-5 rounded-full bg-indigo-500"/><span className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Section 1 — Score Summary</span>
            </div>
          ...
          <div className="bg-black border border-slate-800 rounded-2xl overflow-hidden">
            <div className="flex items-center gap-2 p-5 border-b border-slate-800">
              <div className="w-1 h-5 rounded-full bg-indigo-500"/><span className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Section 2 — Model Findings</span>
            </div>
                ...
                return (
                  <div key={m.id} className="hover:bg-slate-950 transition-colors">
                    <button onClick={() => setExpanded(open ? null : m.id)} className="w-full flex items-center gap-3 p-4 text-left">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2"><span className="text-[10px] text-slate-600">M{m.id}</span><span className="text-xs font-bold text-gray-900 dark:text-white">{m.name}</span></div>
          ...
          <div className="bg-black border border-slate-800 rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-3"><div className="w-1 h-5 rounded-full bg-indigo-500"/><span className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Section 3 — Executive Summary</span></div>
          ...
          {report.rebuilt && (
            <div className="bg-black border border-rose-500/20 rounded-2xl overflow-hidden">
              <div className="flex items-center justify-between p-5 border-b border-slate-800">
                <div className="flex items-center gap-2"><div className="w-1 h-5 rounded-full bg-rose-500"/><div><span className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Section 4 — Rebuilt Prompt</span><p className="text-[10px] text-slate-500 mt-0.5">Score below 70 or a model failed — production-ready governed prompt generated.</p></div></div>
      ...
      {!report && !running && (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h3 className="text-sm font-bold text-gray-900 dark:text-white mb-2">Ready to Audit</h3>
          <p className="text-xs text-slate-500 max-w-sm leading-relaxed">Paste any prompt above, set the risk tier, and click <strong className="text-gray-900 dark:text-white">Run Audit</strong> to evaluate it against all 8 governance models.</p>
  ...
  const typeAndRisk = (
    <div className="grid grid-cols-2 gap-4">
      <div className="space-y-2">
        ...
        <select value={promptType} onChange={(e) => setPromptType(e.target.value as PromptType)} className="w-full bg-black border border-slate-800 rounded-xl px-3 py-3 text-gray-900 dark:text-white outline-none focus:border-indigo-500 transition-all text-xs">
      ...
      <div className="space-y-2">
        ...
        <select value={riskTier} onChange={(e) => setRiskTier(e.target.value as RiskTier)} className="w-full bg-black border border-slate-800 rounded-xl px-3 py-3 text-gray-900 dark:text-white outline-none focus:border-indigo-500 transition-all text-xs">
          {(Object.keys(RISK_META) as RiskTier[]).map((r) => <option key={r} value={r}>{RISK_META[r].label}</option>)}
        </select>
      </div>
    </div>
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-slate-950 border border-slate-800 rounded-[2rem] w-full max-w-lg shadow-2xl overflow-hidden max-h-[92vh] flex flex-col">
        <div className="p-6 border-b border-slate-800 flex items-center justify-between shrink-0">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white">New Prompt</h3>
        ...
        <div className="p-6 space-y-5 overflow-y-auto">
          {(mode === "scratch" || mode === "workflow_node") && (
            <>
              <div className="space-y-2">
                ...
                <input value={name} onChange={(e) => setName(e.target.value)} placeholder="e.g. Brand Voice — Content Lead" className="w-full bg-black border border-slate-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder:text-slate-700 outline-none focus:border-indigo-500 transition-all" />
              </div>
              {mode === "workflow_node" && (
                <>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Workflow *</label>
                    <select value={workflowId} onChange={(e) => setWorkflowId(e.target.value)} className="w-full bg-black border border-slate-800 rounded-xl px-3 py-3 text-gray-900 dark:text-white outline-none focus:border-indigo-500 transition-all text-xs">
                  ...
                  <div className="space-y-2">
                    ...
                    <input value={nodeName} onChange={(e) => setNodeName(e.target.value)} placeholder="e.g. caption-generation node" className="w-full bg-black border border-slate-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder:text-slate-700 outline-none focus:border-indigo-500 transition-all" />
                  </div>
                </>
              )}
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Description</label>
                <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Purpose and scope of this prompt..." className="w-full bg-black border border-slate-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder:text-slate-700 outline-none focus:border-indigo-500 transition-all h-20 resize-none text-sm" />
              </div>
              {typeAndRisk}
            </>
          )}
          ...
          {(mode === "template" || mode === "clone") && (
            <>
              ...
              <div className="space-y-2">
                ...
                <select value={sourceId} onChange={(e) => setSourceId(e.target.value)} className="w-full bg-black border border-slate-800 rounded-xl px-3 py-3 text-gray-900 dark:text-white outline-none focus:border-indigo-500 transition-all text-xs">
              ...
              {mode === "template" && (
                <>
                  <div className="space-y-2">
                    ...
                    <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Defaults to “<source> (From Template)”" className="w-full bg-black border border-slate-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder:text-slate-700 outline-none focus:border-indigo-500 transition-all" />
                  </div>
                  {typeAndRisk}
                </>
              )}
          ...
          {mode === "import" && (
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-black border border-slate-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder:text-slate-700 outline-none focus:border-indigo-500 transition-all h-48 resize-none text-[11px] font-mono"
              />
            </div>
          )}
          ...
          <button onClick={submit} disabled={creating} className="w-full py-4 bg-indigo-500 text-gray-900 dark:text-white rounded-2xl font-black text-sm hover:bg-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 shadow-xl shadow-indigo-500/20">
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-3">
          {rows.map((r, i) => (
            <div key={i} className="p-4 bg-black border border-slate-900 rounded-2xl space-y-3">
              <div className="flex items-center gap-2">
                <input disabled={!editable} value={r.name} onChange={(e) => update(i, { name: e.target.value })} placeholder="variable_name" className="flex-1 bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-xs font-mono text-gray-900 dark:text-white outline-none focus:border-indigo-500 disabled:opacity-60" />
              ...
              <div className="grid grid-cols-2 gap-2">
                <input disabled={!editable} value={r.allowedValues} onChange={(e) => update(i, { allowedValues: e.target.value })} placeholder="Allowed values (comma-separated)" className="bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-[11px] text-gray-900 dark:text-white outline-none focus:border-indigo-500 disabled:opacity-60" />
                <input disabled={!editable} value={r.validationRule} onChange={(e) => update(i, { validationRule: e.target.value })} placeholder="Validation regex" className="bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-[11px] font-mono text-gray-900 dark:text-white outline-none focus:border-indigo-500 disabled:opacity-60" />
                <input disabled={!editable} value={r.fallbackValue} onChange={(e) => update(i, { fallbackValue: e.target.value })} placeholder="Fallback / default value" className="bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-[11px] text-gray-900 dark:text-white outline-none focus:border-indigo-500 disabled:opacity-60" />
                <input disabled={!editable} value={r.example} onChange={(e) => update(i, { example: e.target.value })} placeholder="Example" className="bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-[11px] text-gray-900 dark:text-white outline-none focus:border-indigo-500 disabled:opacity-60" />
              </div>
            </div>
          ))}
        </div>
      ...
      {editable && rows.length > 0 && (
        <button onClick={save} disabled={saving} className="w-full py-3 bg-indigo-500 text-gray-900 dark:text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-indigo-600 disabled:opacity-50 transition-all flex items-center justify-center gap-2">
...
function GuardrailEditor({ promptId, versionId, editable }: { promptId: string; versionId?: string; editable: boolean }) {
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-2">
          {rows.map((r, i) => (
            <div key={i} className="p-3 bg-black border border-slate-900 rounded-2xl space-y-2">
              ...
              <textarea disabled={!editable} value={r.rule} onChange={(e) => update(i, { rule: e.target.value })} placeholder="Guardrail rule text…" className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-[11px] text-gray-900 dark:text-white outline-none focus:border-rose-500 h-16 resize-none disabled:opacity-60" />
            </div>
          ))}
        </div>
      )}
      ...
      {notice && <div className="flex items-center gap-2 rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-3 text-[11px] text-emerald-400"><Check className="w-4 h-4 shrink-0" /><span>{notice}</span></div>}
      {editable && rows.length > 0 && (
        <button onClick={save} disabled={saving} className="w-full py-3 bg-rose-500 text-gray-900 dark:text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-rose-600 disabled:opacity-50 transition-all flex items-center justify-center gap-2">
      ...
      <div className="bg-slate-950 border border-emerald-500/25 rounded-[2rem] w-full max-w-lg shadow-2xl overflow-hidden">
        <div className="p-6 border-b border-slate-800 flex items-center justify-between bg-emerald-500/5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-white">Deployment Confirmed</h3>
          </div>
          <button onClick={onClose} className="text-slate-500 hover:text-white transition-colors"><XCircle className="w-5 h-5" /></button>
        </div>
        <div className="p-6 space-y-5">
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold text-gray-900 dark:text-white">{prompt.name}</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            {rows.map((r) => (
              <div key={r.label} className="p-3 bg-black border border-slate-900 rounded-xl">
                ...
                <div className="text-[11px] text-gray-900 dark:text-white font-bold mt-1 break-words">{r.value}</div>
              </div>
            ))}
          </div>
          <div>
      ...
      <div className="bg-slate-950 border border-rose-500/25 rounded-[2rem] w-full max-w-md shadow-2xl overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select value={category} onChange={(e) => setCategory(e.target.value)} className="w-full bg-black border border-slate-800 rounded-xl px-3 py-3 text-gray-900 dark:text-white outline-none focus:border-rose-500 transition-all text-xs">
          ...
          <div className="space-y-2">
            ...
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Describe the specific change required…" className="w-full bg-black border border-slate-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder:text-slate-700 outline-none focus:border-rose-500 transition-all h-24 resize-none text-sm" />
          </div>
          <div className="flex gap-2">
            ...
            <button onClick={() => onConfirm(category, notes.trim())} disabled={!valid} className="flex-1 py-3 rounded-xl bg-rose-600 text-gray-900 dark:text-white font-bold text-sm hover:bg-rose-500 disabled:opacity-50 transition-all">Submit</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div ref={drawerRef} className="w-full max-w-2xl bg-slate-950 border-l border-slate-800 overflow-y-auto flex flex-col">
        ...
        <div className="p-6 border-b border-slate-800 space-y-4 sticky top-0 bg-slate-950 z-10">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-2">
              <div className="text-lg font-black text-gray-900 dark:text-white">{prompt.name}</div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={f.label} className="p-3 bg-black border border-slate-900 rounded-xl">
                    <div className="text-[9px] text-slate-600 uppercase tracking-widest">{f.label}</div>
                    <div className="text-xs text-gray-900 dark:text-white font-bold mt-1">{f.value}</div>
                  </div>
                ))}
              </div>
              <div>
  ...
  return (
    <div className="p-6 xl:p-8 max-w-screen-2xl mx-auto space-y-8 pb-32 bg-black min-h-screen">
      ...
      <div className="relative overflow-hidden bg-slate-950 border border-indigo-500/20 rounded-[3rem] p-10 xl:p-14 shadow-[0_0_80px_rgba(99,102,241,0.1)]">
        ...
        <div className="relative z-10 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-8">
          <div className="space-y-4 max-w-2xl">
            ...
            <h1 className="text-5xl xl:text-6xl font-black text-gray-900 dark:text-white tracking-tighter leading-none">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => setShowCreateModal(true)} className="px-8 py-3 bg-indigo-600 hover:bg-indigo-500 text-gray-900 dark:text-white rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 transition-all shadow-xl shadow-indigo-600/20 active:scale-95">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-4">
        {([
          { label: "Total Prompts", value: prompts.length, icon: MessageSquareCode, color: "text-gray-900 dark:text-white", apply: () => { setFilterStatus("ALL"); setFilterTest("ALL"); } },
