...
const WORKFLOW_STATUS_STYLES: Record<WorkflowStatus, string> = {
  Draft: "bg-zinc-500/10 text-gray-500 dark:text-zinc-400 border-zinc-500/20",
                  ...
                  <div className="flex flex-wrap gap-2">
                    {availableActions.map((action) => (
                      <button
                        ...
                        onClick={action.fn}
                        className={`flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-gray-900 dark:text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors ${action.color}`}
                      >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-indigo-500 hover:bg-indigo-600 rounded-xl text-sm font-semibold text-gray-900 dark:text-white transition-all"
          >
