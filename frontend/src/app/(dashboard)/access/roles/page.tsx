      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {!showForm && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-gray-900 dark:text-white text-sm font-semibold rounded-xl transition-colors"
          >
        ...
        <div className="mb-6 p-5 bg-[var(--card)] border border-[var(--border)] rounded-2xl space-y-4">
          ...
          <div className="flex items-center gap-3 pt-1">
            <button
              ...
              className="px-5 py-2 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-gray-900 dark:text-white text-sm font-semibold rounded-xl transition-colors"
            >
