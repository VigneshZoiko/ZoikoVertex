        ...
        <>
            ...
            <div className="lg:col-span-4 bg-[#050505] border border-slate-900 rounded-[3rem] p-10 shadow-2xl flex flex-col items-center text-center space-y-6">
              ...
              <div className="relative w-48 h-48 flex items-center justify-center">
                ...
                <div className="absolute flex flex-col items-center justify-center">
                  <span className="text-5xl font-black text-gray-900 dark:text-white tracking-tighter">{data?.collusion_index}%</span>
              ...
              {[
                ...
                <div key={i} className="bg-[#050505] border border-slate-900 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group hover:border-rose-500/40 transition-all flex flex-col justify-between">
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="text-4xl font-black text-gray-900 dark:text-white tracking-tighter">{card.value}</div>
          ...
          <div className="bg-[#050505] border border-slate-900 rounded-[3rem] p-10 shadow-2xl space-y-6">
            <div className="flex items-center justify-between border-b border-slate-900 pb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Live Incident Feed</h2>
            ...
            {!data?.incidents || data.incidents.length === 0 ? (
              <div className="text-center py-16 flex flex-col items-center gap-4">
                ...
                <div>
                  <p className="text-gray-900 dark:text-white font-bold text-sm">No Insider Risk Incidents Found</p>
                  ...
                  <tbody>
                    {data.incidents.map((incident) => (
                      <tr key={incident.id} className="border-b border-slate-900/50 hover:bg-slate-950/40 transition-colors">
                        <td className="py-5 px-6 font-bold text-gray-900 dark:text-white flex items-center gap-3">
          ...
          <div className="bg-slate-950 border border-rose-500/20 rounded-[3rem] p-10 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-2 max-w-xl">
              <h3 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tighter">Emergency Autonomy Lock</h3>
            ...
            <button className="bg-rose-600 hover:bg-rose-500 text-gray-900 dark:text-white font-black text-xs uppercase tracking-widest px-8 py-5 rounded-2xl flex items-center gap-3 transition-all shadow-xl shadow-rose-600/20">
