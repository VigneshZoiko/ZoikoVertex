          ...
          <div className="flex items-center justify-between mt-3">
            <div className="relative flex-1 mr-3">
              ...
              <input 
                ...
                className="w-full bg-black border border-[#2d2d2d] focus:border-[#555] rounded-lg pl-9 pr-4 py-1.5 text-xs text-white focus:outline-none"
              />
            </div>
            <button onClick={fetchQueue} className="p-2 bg-[#222] hover:bg-[#333] border border-[#333] rounded-lg text-white transition-colors">
          ...
          {queue.length > 0 ? queue.map((item) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="text-xs font-bold text-white leading-tight mb-1">{item.brand} — {item.item_type}</h4>
          ...
          <>
            <div className="p-6 border-b border-[#222] bg-[#111]/80 backdrop-blur flex justify-between items-center">
              <div>
                ...
                <h1 className="text-2xl font-black text-white">{selectedItem.item_type} Review</h1>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#111] border border-rose-500/20 rounded-xl p-4">
                    ...
                    <span className="text-xs text-white font-mono">{selectedItem.policy_match}</span>
              ...
              <div className="bg-[#111] border border-[#333] rounded-2xl p-6 shadow-2xl relative">
                ...
                <div className="mb-5">
                  ...
                  <textarea 
                    ...
                    className="w-full h-24 bg-[#050505] border border-[#333] focus:border-amber-500/50 rounded-xl p-4 text-xs text-white placeholder-[#555] resize-none focus:outline-none focus:ring-1 focus:ring-amber-500/50"
                  />
                  {actionError && (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <button 
                    ...
                    className="py-3 px-4 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-xs font-black rounded-xl transition-all shadow-lg flex flex-col items-center justify-center gap-1"
                  >
                  ...
                  <button 
                    ...
                    disabled={submitting}
                    className="py-3 px-4 bg-rose-600 hover:bg-rose-700 disabled:opacity-50 text-white text-xs font-black rounded-xl transition-all flex flex-col items-center justify-center gap-1"
                  >
                  ...
                  <button 
                    ...
                    disabled={submitting}
                    className="py-3 px-4 bg-[#222] hover:bg-[#333] border border-[#444] text-white text-xs font-bold rounded-xl transition-all flex flex-col items-center justify-center gap-1"
                  >
                  ...
                  <button 
                    ...
                    disabled={submitting}
                    className="py-3 px-4 bg-orange-600 hover:bg-orange-700 text-white text-xs font-bold rounded-xl transition-all flex flex-col items-center justify-center gap-1"
                  >
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="text-white font-mono">{selectedItem.agent_id}</span>
                </div>
                <div className="flex justify-between text-xs">
                  <span className="text-[#666]">Source Workspace</span>
                  <span className="text-white font-mono">{selectedItem.workspace_id?.substring(0,8)}</span>
                </div>
                <div className="mt-3">
