          ...
          <div className="flex flex-wrap items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-xl font-black text-foreground">{criticalCount}</h3>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-xl font-black text-foreground">{highCount}</h3>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`px-4 py-2 text-xs font-bold border rounded-xl transition-all flex items-center gap-1.5 ${
                isFilterRailOpen 
                  ? "bg-[#222] border-[#444] text-foreground" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start flex-1">
            ...
            <div className="lg:col-span-1 bg-[#111] border border-[#222] rounded-2xl p-5 space-y-6 shadow-xl">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-black border border-[#2d2d2d] focus:border-[#444] rounded-xl px-3 py-2 text-xs text-foreground focus:outline-none"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-black border border-[#2d2d2d] focus:border-[#444] rounded-xl px-3 py-2 text-xs text-foreground focus:outline-none cursor-pointer"
                >
              ...
              <div className="p-3.5 bg-black/50 border border-[#2d2d2d] rounded-xl space-y-2 text-[10px] text-[#666]">
                <p className="text-foreground font-bold mb-1 block">Triage Operational Guide</p>
          ...
          <div className={`${isFilterRailOpen ? "lg:col-span-3" : "lg:col-span-4"} bg-[#111] border border-[#222] rounded-2xl overflow-hidden shadow-xl`}>
            ...
            <div className="p-5 border-b border-[#222] flex justify-between items-center">
              <div>
                <h2 className="text-sm font-bold text-foreground uppercase tracking-wider">Risk Intake Stream Queue</h2>
              ...
              >
                <RefreshCw className={`w-3.5 h-3.5 text-foreground ${isRefreshing ? "animate-spin" : ""}`} />
              </button>
            </div>
                        ...
                        >
                          ...
                          <td className="py-4 px-4">
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-[10px] font-bold text-foreground capitalize">{sig.status}</span>
                            </div>
                          </td>

                          {/* Title */}
                          <td className="py-4 px-4 max-w-[200px]">
                            <div className="font-bold text-foreground truncate" title={sig.title}>{sig.title}</div>
                          ...
                          <td className="py-4 px-5 text-right">
                            <button
                              ...
                              className="px-2.5 py-1 bg-[#1a1a1a] hover:bg-[#2c2c2c] border border-[#2d2d2d] hover:border-[#444] rounded text-foreground text-[10px] font-bold transition-all"
                            >
                              Inspect
                            </button>
                          </td>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#141414] border border-[#222] p-3 rounded-xl">
                  ...
                  <span className="text-xs font-bold text-foreground block mt-0.5">{new Date(selectedSignal.ingested_at).toLocaleTimeString()}</span>
                </div>
                <div className="bg-[#141414] border border-[#222] p-3 rounded-xl">
              ...
              <div className="bg-amber-500/5 border border-amber-500/20 p-4 rounded-xl space-y-2.5">
                ...
                <div className="flex items-center gap-4 text-xs">
                  <div>
                    ...
                    <strong className="text-foreground">{(selectedSignal.confidence * 100).toFixed(0)}%</strong>
                  </div>
                  <div>
                    <span className="text-[9px] text-[#666] block">Suggested Domain</span>
                    <strong className="text-foreground">{selectedSignal.primary_domain}</strong>
                  </div>
                  <div>
                    <span className="text-[9px] text-[#666] block">Signal Trace</span>
                    <span className="text-foreground font-mono text-[9px]">TR-SIG-{selectedSignal.id.substring(0, 6).toUpperCase()}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-[#222] pt-4">
                ...
                {showScoreCalc ? (
                  <div className="mt-4 p-4 bg-[#141414] border border-[#2d2d2d] rounded-xl space-y-3.5">
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-bold text-foreground uppercase">Severity Calculator</span>
                      <div className="text-right">
                        ...
                        <span className="text-xs font-extrabold text-foreground ml-2">{getCalculatedScore().score}%</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-[10px] text-[#888]">
                        <span>Impact (30%)</span>
                        <span className="text-foreground font-mono">{impactScore}%</span>
                      </div>
                      <input
                      ...
                      <div className="flex justify-between text-[10px] text-[#888] pt-1">
                        ...
                        <span className="text-foreground font-mono">{likelihoodScore}%</span>
                      </div>
                      <input
                      ...
                      <div className="flex justify-between text-[10px] text-[#888] pt-1">
                        ...
                        <span className="text-foreground font-mono">{exposureScore}%</span>
                      </div>
                      <input
                      ...
                      <div className="flex justify-between text-[10px] text-[#888] pt-1">
                        ...
                        <span className="text-foreground font-mono">{controlFailureScore}%</span>
                      </div>
                      <input
                      ...
                      <div className="flex justify-between text-[10px] text-[#888] pt-1">
                        ...
                        <span className="text-foreground font-mono">{regSensitivityScore}%</span>
                      </div>
                      <input
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full bg-black border border-[#2d2d2d] focus:border-[#444] rounded-xl px-3 py-2.5 text-xs text-foreground focus:outline-none"
                      >
                        <option value="Low">Low</option>
                        <option value="Medium">Medium</option>
                        <option value="High">High</option>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full h-20 bg-black border border-[#2d2d2d] focus:border-[#444] rounded-xl p-3 text-xs text-foreground focus:outline-none resize-none placeholder-[#555]"
                  required
                />
              </div>
            </div>
            ...
            <form onSubmit={handleCreateManualSubmit} className="mt-5 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black border border-[#2d2d2d] focus:border-[#444] rounded-xl px-4 py-2.5 text-xs text-foreground focus:outline-none"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-24 bg-black border border-[#2d2d2d] focus:border-[#444] rounded-xl p-3 text-xs text-foreground focus:outline-none resize-none"
                  required
                />
              </div>
              ...
              <div className="flex gap-3 justify-end pt-2">
                <button
                  ...
                  className="px-4 py-2 bg-neutral-900 border border-[#2d2d2d] hover:bg-neutral-800 text-foreground rounded-xl text-xs font-bold transition-all"
                >
                  Cancel
                </button>
                <button
