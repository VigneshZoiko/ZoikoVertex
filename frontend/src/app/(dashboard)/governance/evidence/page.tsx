            ...
            <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-5 flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3 mt-3">
                  <button onClick={() => downloadPack(buildResult.id)} className="flex items-center gap-2 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-foreground text-xs font-bold rounded-lg">
