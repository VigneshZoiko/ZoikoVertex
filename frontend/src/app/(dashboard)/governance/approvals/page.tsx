        ...
        <div className="shrink-0 px-4 pt-3 pb-2">
          <div className="rounded-xl border border-amber-500/25 bg-amber-500/5 overflow-hidden">
            <div className="flex items-center justify-between px-3 py-2 border-b border-amber-500/20">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-[#888]">Take action on the Knowledge Base page</span>
                ...
                {kbLoading && <RefreshCcw className="w-3 h-3 text-[#888] animate-spin" />}
              </div>
            </div>
            <div className="flex flex-wrap gap-2 px-3 py-2">
              {pendingKbSources.map((src: any) => (
                <a key={src.id} href="/agents/knowledge"
                  className="inline-flex items-center gap-2 px-2.5 py-1.5 rounded-lg border border-amber-500/20 bg-[#1a1a1a] hover:bg-[#222] transition group min-w-0 max-w-[220px]">
                  ...
                  <ExternalLink className="w-3 h-3 text-[#555] group-hover:text-amber-400 shrink-0 ml-auto" />
                </a>
              ))}
            </div>
          </div>
