        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex gap-4">
             <div className="bg-black border border-slate-800 rounded-3xl p-8 text-center space-y-2 shadow-2xl">
                <div className="text-5xl font-black text-white tracking-tighter">{data?.trust_score}%</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 bg-[#050505] border border-slate-900 rounded-[3rem] p-10 shadow-2xl space-y-10">
           <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                 ...
                 <h2 className="text-xl font-black text-white uppercase tracking-tighter italic">Faithfulness History</h2>
              </div>
           ...
           <div className="h-64 flex items-end gap-2 px-4 border-b border-slate-900 pb-2">
              {data?.performance_history?.map((p: any, i: number) => (
                ...
                >
                   <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap bg-indigo-600 text-white text-[8px] font-black px-2 py-1 rounded shadow-xl z-20">
                      Score: {p.score}
                   </div>
                </div>
              ))}
        ...
        <div className="lg:col-span-4 space-y-8">
           <div className="bg-[#050505] border border-slate-900 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden">
              ...
              <button className="w-full mt-10 bg-indigo-600 hover:bg-indigo-500 text-white py-5 rounded-[1.5rem] font-black text-xs uppercase tracking-[0.3em] shadow-xl transition-all shadow-indigo-600/20">
