...
export default function DashboardNotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-6 animate-in fade-in zoom-in-95 duration-500">
      ...
      <Link
        href="/dashboard"
        className="flex items-center gap-2 px-6 py-3 bg-indigo-500 hover:bg-indigo-600 text-gray-900 dark:text-white font-semibold rounded-xl transition-all shadow-lg shadow-indigo-500/20 hover:scale-105 active:scale-95"
      >
