  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-6 animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="relative mb-8">
        <div className="absolute inset-0 bg-warning-text/20 blur-[80px] rounded-full animate-pulse" />
        ...
        <div className="absolute -top-2 -right-2 w-8 h-8 bg-[var(--card)] border border-[var(--border)] rounded-xl flex items-center justify-center text-xs font-black text-warning-text">
          404
        </div>
      </div>
      ...
      <Link
        href="/dashboard"
        className="flex items-center gap-2 px-6 py-3 bg-info-text hover:bg-info-text text-foreground font-semibold rounded-xl transition-all shadow-lg shadow-info-text/20 hover:scale-105 active:scale-95"
      >
