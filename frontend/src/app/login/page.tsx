  ...
  return (
    <AuthLayout>
      <div className="w-full max-w-[480px]">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-[1.75rem] font-black text-white/90 mb-1">Sign in to ZoikoVertex</h1>
          <p className="text-[14px] text-white/45">Access your corporate workspace.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#1E2F55] bg-[#0C1529] pl-11 pr-12 py-3.5 text-sm text-white/80 placeholder-white/20 outline-none transition focus:border-[#20E7F2]/50 focus:ring-1 focus:ring-[#20E7F2]/20"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-2.5 rounded-xl bg-[#20E7F2] py-3.5 text-sm font-bold text-[#080E1A] transition hover:bg-[#20E7F2]/90 active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed mt-2"
          >
            {loading ? (
