    ...
    <div className="flex gap-3 justify-center">
      {value.map((digit, idx) => (
        <input
          ...
          onPaste={handlePaste}
          className="h-14 w-12 rounded-xl border border-[#1E2F55] bg-[#0C1529] text-center text-xl font-bold text-white/90 outline-none transition focus:border-[#20E7F2]/60 focus:ring-1 focus:ring-[#20E7F2]/20 caret-[#20E7F2]"
        />
      ))}
    </div>
  );
