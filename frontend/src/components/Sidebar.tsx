...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    icon: FileSearch,
    items: [
      { name: "Audit Trail",       href: "/evidence/audit-trail", icon: FileSearch, roles: ["ADMIN","WORKSPACE_OWNER","GOVERNANCE_ADMIN","AUDITOR","COMPLIANCE_REVIEWER"] },
      { name: "Forensic Hub",      href: "/evidence/forensic-hub", icon: Fingerprint,roles: ["ADMIN","WORKSPACE_OWNER","GOVERNANCE_ADMIN","AUDITOR","COMPLIANCE_REVIEWER","SECURITY_ADMIN"] },
      { name: "Evidence Vault",    href: "/evidence/evidence-vault", icon: Archive,    roles: ["ADMIN","WORKSPACE_OWNER","GOVERNANCE_ADMIN","AUDITOR","COMPLIANCE_REVIEWER"] },
      { name: "Legal Holds",       href: "/evidence/evidence-vault/holds", icon: Gavel, roles: ["ADMIN","WORKSPACE_OWNER","GOVERNANCE_ADMIN","AUDITOR","COMPLIANCE_REVIEWER"] },
