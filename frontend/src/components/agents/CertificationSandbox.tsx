  ...
  return (
    <div ref={modalRef} className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[var(--overlay)] backdrop-blur-md animate-in fade-in duration-500">
      <div className="bg-[var(--card)] border border-[var(--card-border)] w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
        <div className="px-8 py-6 border-b border-[var(--card-border)] bg-indigo-600 text-gray-900 dark:text-white flex items-center justify-between shrink-0">
          ...
          <div className="w-1/2 p-6 border-r border-[var(--card-border)] overflow-y-auto space-y-4">
            ...
            <div className="pt-4 space-y-4">
              ...
              {!isCertified && !testing && (
                <button
                  onClick={runSandbox}
                  className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-gray-900 dark:text-white py-3 rounded-xl font-bold transition-all shadow-lg shadow-indigo-600/20"
                >
                ...
                <div className="space-y-4">
                  ...
                  {overallResult === 'pass' && (
                    <button
                      ...
                      disabled={finalizing}
                      className="w-full bg-emerald-600 hover:bg-emerald-500 text-gray-900 dark:text-white py-3 rounded-xl font-bold transition-all shadow-lg shadow-emerald-600/20 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      {finalizing ? (
                        <>
                          <Loader2 className="w-4 h-4 animate-spin" />
