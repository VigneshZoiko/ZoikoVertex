...
export default function ConfirmActionModal({
  ...
  const canConfirm = mode === 'confirm'
    ? (requireReason ? reasonValue.trim().length > 0 : true)
        ...
        <div className="p-8">
          ...
          {requireReason && (
            <textarea
              ...
              onKeyDown={(e) => { if (e.key === 'Enter' && (e.metaKey || e.ctrlKey) && canConfirm) handleConfirm(); }}
            />
          )}
