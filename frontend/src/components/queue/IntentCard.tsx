      ...
      <div className="p-6 flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[var(--border)]/50">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-xs font-bold text-foreground shadow-lg shadow-indigo-500/10">
              ...
              <div className="flex flex-col gap-3 w-full md:w-auto ml-4">
                ...
                <div className="flex gap-2 justify-end">
                  ...
                  <button 
                    ...
                    className="px-4 py-1.5 bg-indigo-500 text-foreground hover:bg-indigo-400 rounded-lg text-[10px] font-bold transition-all shadow-lg shadow-indigo-500/20 uppercase"
                  >
                    Approve
                  </button>
                </div>
              ...
              <div className="flex flex-col gap-3 w-full md:w-auto ml-4">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <button 
                    ...
                    className="px-5 py-2 bg-indigo-600 text-foreground hover:bg-indigo-500 rounded-xl text-[10px] font-bold transition-all shadow-lg shadow-indigo-500/20 uppercase"
                  >
                    Approve & Escalate
                  </button>
                </div>
