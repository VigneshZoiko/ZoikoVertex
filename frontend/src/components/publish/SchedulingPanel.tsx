    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold py-2 px-4 rounded-xl flex items-center gap-2 transition-colors shadow-lg shadow-indigo-600/20 disabled:opacity-50"
        >
          {isFetchingRecommendations ? (
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div>
          ...
          <select 
            ...
            className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-white text-xs outline-none focus:border-indigo-500"
          >
