    ...
    <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6">
      ...
      {!mediaPreview ? (
        ...
        <div className="relative rounded-xl overflow-hidden bg-black aspect-video flex items-center justify-center border border-[var(--border)]">
          ...
          <button
            onClick={onClear}
            className="absolute top-3 right-3 bg-white dark:bg-zinc-950/80 hover:bg-rose-500 text-gray-900 dark:text-white p-2 rounded-xl backdrop-blur-md transition-all border border-white/10"
            title="Remove Media"
          >
            <X className="w-4 h-4" />
          </button>
