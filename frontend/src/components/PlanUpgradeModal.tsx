    ...
    >
      <div className="relative w-full max-w-md bg-surface border border-border rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-start justify-between p-6 pb-4 border-b border-border">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-foreground-muted hover:text-white hover:bg-surface-hover transition-all"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-5">
          <p className="text-sm text-foreground-muted leading-relaxed">{reason}</p>

          {perks.length > 0 && (
            <div className="p-4 bg-surface-hover border border-border/60 rounded-xl space-y-2.5">
        ...
        <div className="px-6 pb-6 flex flex-col gap-2">
          ...
          <button
            onClick={onClose}
            className="w-full py-2.5 text-sm text-foreground-muted hover:text-foreground-muted transition-colors"
          >
            Maybe later
          </button>
        </div>
