...
export default function Hero() {
  return (
    <section className="bg-[#080812] pt-10 pb-10 px-6">
      <div
        className="mx-auto w-full max-w-[1473px] grid gap-6 items-center lg:[grid-template-columns:584.34px_711px]"
        style={{ minHeight: 820 }}
      >
        ...
        <div className="relative hidden lg:block lg:-ml-10">
          <div className="relative w-full lg:w-[1100px] h-[600px] rounded-2xl overflow-hidden">
            <Image
